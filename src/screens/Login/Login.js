...
const Login = ({ route, navigation }) => {
  ...
  const [showPassword, setShowPassword] = useState(false)
	...
	GoogleSignin.configure({
		...
		iosClientId: '46439986389-gth7r4nqvu8bpmpc1nkg2lqi0prsdsn4.apps.googleusercontent.com', // [iOS] optional, if you want to specify the client ID of type iOS (otherwise, it is taken from GoogleService-Info.plist)
					...
					<View style={styles.signInContent}>
						...
						<View style={styles.emailOrPhoneContainer}>
							<Text style={styles.emailOrPhoneText}>
								{strings("Email or Phone number")}
							</Text>
						</View>
						<View style={[inputStyles.container, mailIsFocus ? styles.mailPhoneStyle : ""]}>
							<TextInput
								placeholder={strings("Email or Phone number")}
						...
						<View style={[inputStyles.container, passwordIsFocus ? styles.passwordStyle : ""]}>
							...
							/>
							<TouchableOpacity style={[styles.textInputImage, { marginTop: calcHeight(20) }]} onPress={() => setShowPassword(!showPassword)}>
                                <Text style={styles.showText}>{showPassword ? strings("hide") : strings("show")}</Text>
                            </TouchableOpacity>
						</View>
